...
*/
                $ret_str2 .= "<input type=\"hidden\" value=\"" . $arr_waku[$i]["ps"] . "\" id=\"" . $i . "Ps\" name=\"data[" . $i . "][ps]\">\n";
                $ret_str2 .= "<input type=\"hidden\" value=\"" . $arr_waku[$i]["x"] . "\" id=\"" . $i . "X\" name=\"data[" . $i . "][x]\">\n";
                $ret_str2 .= "<input type=\"hidden\" value=\"" . $arr_waku[$i]["y"] . "\" id=\"" . $i . "Y\" name=\"data[" . $i . "][y]\">\n";
                $ret_str2 .= "<input type=\"hidden\" value=\"" . $arr_waku[$i]["dai"] . "\" id=\"" . $i . "Dai\" name=\"data[" . $i . "][dai]\">\n";
                $ret_str2 .= "<input type=\"hidden\" value=\"" . $arr_waku[$i]["ang"] . "\" id=\"" . $i . "Ang\" name=\"data[" . $i . "][ang]\">\n";
                if (!(empty($arr_waku[$i]["shima"]))){
                    for ($j = 0; $j <= count($arr_waku[$i]["shima"]) - 1; $j++){
                            $ret_str2 .= "<input type=\"hidden\" value=\"" . $arr_waku[$i]["shima"][$j] . "\" name=\"data[" . $i . "][shima][]\" class=\"shima" . $i . "\">\n";
                    }
                }       
...
//    $ret_str .= "</div>\n";
    ...
    $ret_str .= "<div id=\"dataarea\">\n";
    $ret_str .= $ret_str2;
    $ret_str .= "</div>\n";

    $ret_str .= "<script type=\"text/javascript\" src=\"js/waku.js\">\n";
    $ret_str .= "</script>\n";
